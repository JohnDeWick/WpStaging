...
if (!function_exists('cs_profile_menu')) {
	...
	<?php if (isset($cs_candidate_dashboard_vew) && $cs_candidate_dashboard_vew == 'default') { ?> 
		...
		?> 
			...
			<li>
			    <a href="javascript:void(0)" onclick="cs_remove_profile('<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($uid) ?>', 'cand')"><i class="icon-trash4"></i><?php esc_html_e('Delete Profile', 'jobhunt'); ?></a>
			</li>
		...
		<div class="cs-loging-dashboard">
			...
			<div class="cs-login-dropdown">
				...
				if ($cs_user_role_type == 'candidate') {
					...
					<li>
					    <a href="javascript:void(0)" onclick="cs_remove_profile('<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($uid) ?>', 'emp')"><i class="icon-trash4"></i><?php esc_html_e('Delete Profile', 'jobhunt'); ?></a>
					</li>
