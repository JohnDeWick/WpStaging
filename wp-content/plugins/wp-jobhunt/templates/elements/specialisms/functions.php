...
if (!function_exists('cs_job_specialisms_shortcode')) {
	...
	$btm_class = isset($specialisms_view) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy' || $specialisms_view == 'grid-modern') ? ' simple' : '';
	...
	$cs_html_count = '';
	if ($job_specialisms_subtitle_switch == 'yes' && $specialisms_view != 'simple' && $specialisms_view != 'grid-fancy' && $specialisms_view != 'grid-modern' && $specialisms_view != 'classic-list') {
	...
	if (isset($job_specialisms_title) && !empty($job_specialisms_title) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy' || $specialisms_view == 'grid-modern')) {  // remove title div if empty
	...
	if (isset($specialisms_view) && ($specialisms_view == 'simple' || $specialisms_view == 'grid-fancy' || $specialisms_view == 'grid-modern')) {
	    $cs_html .= $cs_li_html;
	}
	...
	if ($specialisms_view != 'simple' && $specialisms_view != 'grid-fancy' && $specialisms_view != 'grid-modern') {
	    $cs_html .= do_shortcode($content);
	}
